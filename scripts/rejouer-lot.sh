...
declare -A REF_LARAVEL=(
  ...
  [go-page-supervision-profils-crud]=19 [go-page-supervision-version]=14
)
declare -A REF_LEGACY=(
  ...
  [go-page-supervision-profils-crud]=16 [go-page-supervision-version]=12
  [go-vague0-legacy]=0
)
