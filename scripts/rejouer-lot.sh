...
declare -A REF_LARAVEL=(
  ...
  [go-page-supervision-reglages]=32
)
declare -A REF_LEGACY=(
  ...
  [go-page-supervision-reglages]=8
  [go-vague0-legacy]=0
)
SUITES_LARAVEL=(go-socle-navigation go-socle-i18n go-socle-passerelle go-socle-auth
  ...
  go-page-supervision-version go-page-supervision-editeur go-page-supervision-releve go-page-supervision-ecriture go-page-supervision-reglages
