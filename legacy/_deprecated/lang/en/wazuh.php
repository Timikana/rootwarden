...
return [
    ...
    'wazuh.col_network' => 'Network',
    'wazuh.col_criticality' => 'Criticality',
    'wazuh.col_environment' => 'Env',
    ...
    'wazuh.btn_detect' => 'Scan',
    'wazuh.btn_detect_tip' => 'Detect an existing Wazuh agent without reinstalling',
    ...
    'wazuh.btn_install_all' => 'Install on all',
    'wazuh.confirm_install_all' => 'Install Wazuh agent on ALL servers without agent? Sequential operation, may take several minutes.',
    'wazuh.installing_all' => 'Sequential install in progress on all servers without agent... Do not close this page.',
    'wazuh.install_all_failures' => 'Failures',
