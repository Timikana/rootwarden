...
return [
    ...
    'wazuh.col_network' => 'Reseau',
    'wazuh.col_criticality' => 'Criticite',
    ...
    'wazuh.btn_install_all' => 'Installer sur tous',
    'wazuh.confirm_install_all' => 'Installer Wazuh agent sur TOUS les serveurs sans agent ? Operation sequentielle, peut prendre plusieurs minutes.',
    'wazuh.installing_all' => 'Installation sequentielle en cours sur tous les serveurs sans agent... Ne pas fermer cette page.',
    'wazuh.install_all_failures' => 'Echecs',
