...
<aside id="sidebar" class="fixed left-0 top-0 h-full w-56 bg-gray-900 dark:bg-gray-950 border-r border-gray-800 z-50 flex flex-col transition-all duration-200 hidden lg:flex">
    ...
    <nav class="flex-1 px-3 space-y-1 overflow-y-auto">
        ...
        <?= $sideLink('/drift/index.php', '<svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>', t('nav.drift'), t('nav.tip_drift')) ?>
        <?php endif; ?>
        <?php endif; ?>
