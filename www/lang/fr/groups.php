...
return [
    ...
    'groups.tip_new' => 'Creer un groupe : regle dynamique (env/criticite/reseau/tags) ou liste statique de serveurs.',
    'groups.f_name' => 'Nom',
    ...
    'js.groups.tip_members' => 'Afficher les serveurs resolus de ce groupe.',
    'js.groups.tip_drift' => 'Lance un scan de derive de config sur tous les membres (rapide, sans SSH ; suivi dans le centre de taches).',
    'js.groups.tip_cve' => 'Lance un scan CVE complet sur tous les membres (en arriere-plan, suivi dans le centre de taches).',
    'js.groups.tip_delete' => 'Supprime le groupe (les serveurs ne sont pas touches).',
