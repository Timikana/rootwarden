...
routes: [/cron_preview, /cve_compare, /cve_history, /cve_remediation, /cve_remediation/stats, /cve_reprioritize, /cve_results, /cve_scan, /cve_scan_all, /cve_schedules, /cve_schedules/<int:schedule_id>, /cve_test_connection, /cve_whitelist, /cve_whitelist/<int:whitelist_id>]
