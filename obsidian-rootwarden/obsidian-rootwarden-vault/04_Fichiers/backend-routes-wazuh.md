...
routes: [/wazuh/config, /wazuh/detect, /wazuh/group, /wazuh/install, /wazuh/install_all, /wazuh/options, /wazuh/restart, /wazuh/rules, /wazuh/rules/<name>, /wazuh/servers, /wazuh/uninstall]
