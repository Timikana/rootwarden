...
routes: [/delete_remote_user, /deploy, /deploy_platform_key, /deploy_service_account, /logs, /platform_key, /preflight_check, /reenter_ssh_password, /regenerate_platform_key, /remove_ssh_password, /remove_user_keys, /scan_server_users, /server_user_keys, /server_user_remove_key, /test_platform_key]
