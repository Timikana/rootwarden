...
Dernière mesure : **2026-08-24**, version `1.37.49`. Les chiffres de ce document sont
...
| écarts de parité documentés | **85** (`docs/migration/PARITE.md`, numérotés jusqu'à **E-95** — dix numéros, E-23 à E-32, n'ont jamais été utilisés) |
...
| `docs/migration/PARITE.md` | les 85 écarts mesurés entre legacy et portage, avec leur preuve |
