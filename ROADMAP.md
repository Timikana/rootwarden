...
Dernière mesure : **2026-08-24**, version `1.37.50`. Les chiffres de ce document sont
...
| écarts de parité documentés | **86** (`docs/migration/PARITE.md`, numérotés jusqu'à **E-96** — dix numéros, E-23 à E-32, n'ont jamais été utilisés) |
...
| `docs/migration/PARITE.md` | les 86 écarts mesurés entre legacy et portage, avec leur preuve |
