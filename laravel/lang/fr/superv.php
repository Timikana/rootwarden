...
return [
    ...
    'desinst_bouton' => 'Desinstaller',
    'desinst_titre' => "Desinstaller l'agent d'un serveur",
    'desinst_description' => "Retire l'agent de supervision d'UN serveur : le service est arrete, le paquet et sa configuration sont purges. Ce geste DETRUIT et ne se defait pas — reinstaller l'agent demande un deploiement.",
    'desinst_cout' => 'Desinstaller l\'agent de :nom retirera le paquet et sa configuration, y compris :chemin.',
    'desinst_effet_service' => "le service de l'agent est arrete s'il tourne",
    'desinst_effet_purge' => "le paquet est purge : le programme ET ses fichiers de configuration partent. Les autres paquets du serveur ne sont pas touches.",
    'desinst_effet_inventaire' => "la ligne d'inventaire de cet agent est retiree, mais SEULEMENT si la commande a reussi",
    'desinst_aide_verif' => "Apres le geste, le portail relit la version installee sur le serveur pour VERIFIER que l'agent est bien parti, au lieu de se fier a ce que la commande annonce.",
    'desinst_annuler' => 'Annuler',
    'desinst_confirmer' => "Desinstaller l'agent",
    'desinst_en_cours' => 'Desinstallation sur :nom...',
    'desinst_purge' => 'Agent desinstalle de :nom. Paquets purges : :paquets.',
    'desinst_rien' => "Aucun agent n'etait installe sur :nom : il n'y avait rien a desinstaller. L'inventaire a ete mis a jour en consequence.",
    'desinst_echouee' => 'La desinstallation sur :nom a ECHOUE (code :codes). L\'inventaire n\'a pas ete modifie : lisez le journal ci-dessous pour savoir ce qui reste sur le serveur.',
    'desinst_inachevee' => "La desinstallation sur :nom ne s'est pas terminee : le journal est incomplet.",
    'desinst_refus' => 'Desinstallation refusee (statut :statut).',
    'desinst_echec' => "La desinstallation n'a pas pu etre lancee.",
    'desinst_verif_en_cours' => 'Verification sur le serveur...',
    'desinst_verif_absent' => 'Verifie : plus aucun agent n\'est detecte sur ce serveur.',
