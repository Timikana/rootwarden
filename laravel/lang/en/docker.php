...
return [
    ...
    'scan_all_interrompu' => "The stream stopped part-way through: :ok succeeded and :echecs failed had already been reported, and the servers after those were NOT processed. This is neither a global success nor a global failure — reload the page to read the real state.",
