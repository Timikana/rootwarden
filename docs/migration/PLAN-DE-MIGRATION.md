...
| 8 | `iptables/` | 870 | 1 | **INVENTORIÉ — `MODULE-FILTRAGE.md`**, cinq sous-lots I1 à I5. `fail2ban/` se porte AVANT. **E-152** ; gestes sur machines, IDOR déjà corrigé |
| 9 | `fail2ban/` | 872 (2 fichiers) | 1 | **INVENTORIÉ — `MODULE-FILTRAGE.md`**, six sous-lots F1 à F6. **F1 CARACTÉRISÉ `v1.37.99`** (18 legacy, 0 FAIL). **E-152 : sur 23 routes des deux modules, DEUX portent une permission.** GeoIP en HTTP (ip-api gratuit) |
