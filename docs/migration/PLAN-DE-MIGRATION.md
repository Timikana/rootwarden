...
Dernière mise à jour : **2026-09-01** (16:25 CEST), version `1.38.117` — ⚠ `legacy/version.txt` reste à `1.38.115`, **bump volontairement différé jusqu'à la fin du LOT** (E-256 : ce fichier est monté dans le conteneur, donc servi). Le chantier tourne désormais à **huit sessions** (le DSI délégué inclus) à propriété disjointe — table au §10 de `PROTOCOLE-SESSIONS.md`.
...
| LOT de tests E2E | **LOT 2 EN COURS** — PID 3886444, démarré **15:37:23**, **39 exécutions sur 156 à 16:21:32, aucun écart**. Attendu : 79 laravel + 77 legacy. ⚠ **LOT 1 (15:29:58) A ÉTÉ ABATTU** : une écriture non commitée à **15:30:15** — 17 s après son lancement — a fait rendre **PASS=64 FAIL=2** à `go-socle-navigation`, avec **500 sur `/supervision`**. `curl` rend **302** après remise en état : *aucune régression du portage.* **La contre-épreuve (E-254) est ce qui l'établit** — même suite, même référence, 66/0 en arbre stable. *Sans elle, « le FAIL venait de la fenêtre » restait une hypothèse — et celle qui accusait `Machines.php`, qui avait réellement bougé à 14:22, l'était autant.* **La ligne de base du 2026-08-28 (2298 · 2) est PÉRIMÉE** : 67 commits depuis, dont 3 fichiers globaux. Remesure : `./scripts/rejouer-lot.sh`, attendre un **PID enregistré**, **conclure sur le JOURNAL**.
...
| écarts de parité documentés | **248** — numérotés jusqu'à **E-258**, dix numéros jamais servis. **Neufs de la journée du 2026-09-01, et onze sur douze portent sur l'INSTRUMENT plutôt que sur le produit** : E-244 (« I3 porté » déclaré, capacité en 404, faute de transmission du Lead) · E-245 (un rappel accroché à un ordre voyage sans se remesurer) · E-246 + bis (le discriminant est le PRÉFIXE dérivé par sa VALEUR, pas une liste de helpers) · E-247 (le protocole protège la CHARGE, pas l'ARBRE) · E-248 (un correctif issu d'une LECTURE se réfute par une lecture) · E-249 (deux gardes, et le premier est dans le navigateur) · E-250 (deux états opposés sous une même ancre) · **E-251 (ne pas commiter protège l'HISTORIQUE, pas l'ÉTAT SERVI — cinq suites mesuraient des vues renommées)** · E-252 · E-253 (4ᵉ travail redemandé) · E-254 (la contre-épreuve : 64/2 sale contre 66/0 stable) · E-255 (`propre: null` n'aurait rien protégé, `null` est falsy) · E-256 (**le Lead écrit aussi dans l'arbre servi**) · E-257 (**sa règle d'abattage aurait tué 156 exécutions**) · E-258 (le garde signalerait les écritures du LOT lui-même : la distinction est CODE contre ÉTAT D'EXÉCUTION). `grep -c '^## E-' docs/migration/PARITE.md`
