...
| écarts de parité documentés | **156** — numérotés jusqu'à **E-166** : dix numéros, **E-23 à E-32**, n'ont jamais été utilisés. Le dernier numéro n'est donc pas un compte. `grep -c '^## E-' docs/migration/PARITE.md` |
...
**F2 12/11** · **F3 6/7** · **F4 10/4** — et sur ces sept passes de D5,
