...
| **B4** ⏳ | Les écritures distantes — *CARACTÉRISÉ `v1.37.91`, legacy **15 PASS / 0 FAIL**. **PORTAGE SUSPENDU** : deux arbitrages, §7 du plan* | **MODIFIE** le parc. À exercer par interception avec avortement, comme D9a et D9b |
