...
| **B2** ✅ | L'onglet Déploiement en LECTURE — *CARACTÉRISÉ `v1.37.87`, legacy **14 PASS / 0 FAIL**, port à faire* | Ouvre une session SSH, mais ne modifie rien. Le diff est la pièce à porter fidèlement |
